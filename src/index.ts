      ...
      <ha-card>
        ...
        <div class="grid grid-2 section-padding">
          <div class="stats-padding stats-border center">
              ...
              Cells: <span class="clickable ${cellVoltageClass}" @click=${(e) => this._navigate(e, EntityKey.min_cell_voltage)}>${this.getState(EntityKey.min_cell_voltage, 2)} V </span> &nbsp/&nbsp <span class="clickable ${cellVoltageClass}" @click=${(e) => this._navigate(e, EntityKey.average_cell_voltage)}>${this.getState(EntityKey.average_cell_voltage, 2)} V</span> &nbsp/&nbsp <span class="clickable ${cellVoltageClass}" @click=${(e) => this._navigate(e, EntityKey.max_cell_voltage)}>${this.getState(EntityKey.max_cell_voltage, 2)} V</span><br>
